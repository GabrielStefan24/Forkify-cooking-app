...
exports.uploadRecipe = exports.updateServings = exports.state = exports.loadSearchResults = exports.loadRecipe = exports.getSearchResultsPage = exports.deleteBookmark = exports.bookmark = void 0;
var _regeneratorRuntime2 = require("regenerator-runtime");
var _config = require("./config.js");
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 4;
          return (0, _helpers.AJAX)("".concat(_config.API_URL, "?search=").concat(query));
        case 4:
          data = _context2.sent;
          console.log(data);
...
var bookmark = function bookmark(recipe) {
  // Adding bookmarks
...
var deleteBookmark = function deleteBookmark(id) {
  var index = state.bookmarks.findIndex(function (element) {
...
var RecipeView = /*#__PURE__*/function (_View) {
  ...
  function RecipeView() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_errorMessage", 'We could not find a recipe with that name,please try another one!');
...
},{"../../img/icons.svg":"src/img/icons.svg","fracty":"node_modules/fracty/fracty.js","./view":"src/js/views/view.js","../model":"src/js/model.js"}],"src/js/views/searchView.js":[function(require,module,exports) {
"use strict";
...
var PaginationView = /*#__PURE__*/function (_View) {
  ...
  _createClass(PaginationView, [{
    ...
    value: function _addHandlerClick(handler) {
      this._parentElement.addEventListener('click', function (e) {
...
exports.default = _default;
},{"./previewView.js":"src/js/views/previewView.js","../../img/icons.svg":"src/img/icons.svg","./view.js":"src/js/views/view.js"}],"src/js/views/View.js":[function(require,module,exports) {
"use strict";
...
var AddRecipeView = /*#__PURE__*/function (_View) {
  ...
  _createClass(AddRecipeView, [{
    ...
    value: function _addHandlerUpload(handler) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _addRecipeView.default.spinner();
...
init();
},{"./model.js":"src/js/model.js","./config.js":"src/js/config.js","./views/recipeView.js":"src/js/views/recipeView.js","./views/searchView.js":"src/js/views/searchView.js","./views/resultsView.js":"src/js/views/resultsView.js","./views/paginationView.js":"src/js/views/paginationView.js","./views/bookmarksView.js":"src/js/views/bookmarksView.js","./views/addRecipeView.js":"src/js/views/addRecipeView.js","core-js/stable":"node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","regenerator-runtime":"node_modules/regenerator-runtime/runtime.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
